...
def run_pipeline(args):
	...
	luigi.interface.core.threads = luigi.parameter.Parameter(default=args.max_threads, description='total number of threads available for use by the pipeline', config_path=dict(section='resources', name='threads'),)
